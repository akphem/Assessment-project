...
const Testpage = () => {
  ...
  const questions = [
    {
      question: "How do you handle criticism well?",
      options: [
        { text: "Mostly like me", points: 5 },
        { text: "Like me", points: 4 },
        { text: "Sometimes like me", points: 3 },
        { text: "Unlike me", points: 2 },
        { text: "Most unlike me", points: 1 },
      ],
    },
    {
